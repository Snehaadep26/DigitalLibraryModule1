...
public class StudentChapterDetails {
    String chapterNum,topicNum,aboutChapter;
    int vdoCount,noteCount,qCount,chapterId;

    public StudentChapterDetails(String chapterNum, String topicNum, String aboutChapter, int vdoCount, int noteCount, int qCount, int chapterId) {
