...
import com.example.digitallibrarymodule.StudentFragment.StudentFullScreenClient;


public class StudentYoutube extends AppCompatActivity {
    String link,title;
    ImageView back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_youtube);
    ...
    public  void webView(){
        ...
        webView.setWebChromeClient(new StudentFullScreenClient(StudentYoutube.this){
            @Override
