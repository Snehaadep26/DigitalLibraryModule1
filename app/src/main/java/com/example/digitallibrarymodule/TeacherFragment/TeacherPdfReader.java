...
public class TeacherPdfReader extends Fragment {
View view;
    String file,name;
    ImageView back;
    public TeacherPdfReader(String file, String name) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.teacher_fragment_pdf_reader, container, false);
