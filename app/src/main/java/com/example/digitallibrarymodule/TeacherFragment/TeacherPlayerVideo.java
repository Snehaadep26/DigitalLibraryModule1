...
public class TeacherPlayerVideo extends Fragment {
    ...
    public TeacherPlayerVideo(String file, String title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.teacher_fragment_player_video, container, false);
