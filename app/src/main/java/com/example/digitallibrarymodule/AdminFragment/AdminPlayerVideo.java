...
public class AdminPlayerVideo extends Fragment {
View view;
    ...
    public AdminPlayerVideo(String file, String title) {
        this.file=file;
        this.title=title;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view=  inflater.inflate(R.layout.admin_fragment_player_video, container, false);
