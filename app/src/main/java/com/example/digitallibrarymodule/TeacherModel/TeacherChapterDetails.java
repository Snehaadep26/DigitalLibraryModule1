...
public class TeacherChapterDetails {
    String chapterNum,topicNum,aboutChapter;
    int vdoCount,noteCount,qCount,chapterId;

    public TeacherChapterDetails(String chapterNum, String topicNum, String aboutChapter, int vdoCount, int noteCount, int qCount, int chapterId) {
