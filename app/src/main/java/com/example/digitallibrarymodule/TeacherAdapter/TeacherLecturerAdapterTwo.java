...
public class TeacherLecturerAdapterTwo extends RecyclerView.Adapter<TeacherLecturerAdapterTwo.MyviewHolder> {
    ArrayList<TeacherLecturerModelTwo> lecturerModels;
    Context context;
    String pdfFile;
    ...
    public TeacherLecturerAdapterTwo(ArrayList<TeacherLecturerModelTwo> teacherLecturerModelTwo, Context context) {
       lecturerModels= teacherLecturerModelTwo;
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_lecturer_note_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyviewHolder holder, @SuppressLint("RecyclerView") int position) {
        TeacherLecturerModelTwo modal = lecturerModels.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              String file=  modal.getFile();
                ...
                Intent intent = new Intent(context, TeacherWebView.class);
