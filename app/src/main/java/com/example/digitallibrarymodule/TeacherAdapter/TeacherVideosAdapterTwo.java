...
public class TeacherVideosAdapterTwo extends RecyclerView.Adapter<TeacherVideosAdapterTwo.CardViewHolder>
{
    String link="";
    String title,file;
    ...
    public TeacherVideosAdapterTwo(ArrayList<TeacherVideoModelTwo> videoModel, Context context) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_card_video,parent,false);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        TeacherVideoModelTwo currentCards = this.videoModel.get(position);
