...
import com.example.digitallibrarymodule.TeacherFragment.TeacherLibraryFragment;
...
public class TeacherTopicModelAdapter extends RecyclerView.Adapter<TeacherTopicModelAdapter.ViewHolder> {

    // creating a variable for array list and context.
    private ArrayList<TeacherTopicModel> courseModalArrayList;
...
//    String chapterId,standardName,section,chapterName;
    ...
    public TeacherTopicModelAdapter(ArrayList<TeacherTopicModel> courseModalArrayList, Context context, int subjectId, int chapterId, String standardId) {
    ...
    public void filterList(ArrayList<TeacherTopicModel> filterllist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_topic_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        TeacherTopicModel modal = courseModalArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = new TeacherLibraryFragment(topicId,Integer.valueOf(standardId),chapterId,topicName);
