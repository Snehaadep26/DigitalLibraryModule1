...
import com.example.digitallibrarymodule.TeacherFragment.TeacherTopicFragment;
import com.example.digitallibrarymodule.TeacherModel.TeacherChapterDetails;


import java.util.ArrayList;

public class TeacherChapterDetailsAdapter extends RecyclerView.Adapter<TeacherChapterDetailsAdapter.MyViewHolber> {
    ArrayList<TeacherChapterDetails> chapterDetials;
    Context context;
    ...
    public TeacherChapterDetailsAdapter(ArrayList<TeacherChapterDetails> chapterDetials, Context context, int subjectId, String standardid, String section2, String standardName2, String subjectName) {
    ...
    public MyViewHolber onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_subject_mathematics_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolber holder, int position) {
        TeacherChapterDetails currentCards = chapterDetials.get(position);
...
//        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = new TeacherTopicFragment(subjectId,chapterId,standardid,topic);
                FragmentManager fragmentManager = ((FragmentActivity) context).getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
