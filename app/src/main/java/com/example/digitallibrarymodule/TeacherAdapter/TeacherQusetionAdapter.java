...
public class TeacherQusetionAdapter extends RecyclerView.Adapter<TeacherQusetionAdapter.ViewHolder> {
        ArrayList<TeacherQuestionModel> lecturerModels;
        Context activity;
public TeacherQusetionAdapter(ArrayList<TeacherQuestionModel> lecturerModels, Context activity) {
...
public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TeacherQuestionModel currentCards = this.lecturerModels.get(position);
