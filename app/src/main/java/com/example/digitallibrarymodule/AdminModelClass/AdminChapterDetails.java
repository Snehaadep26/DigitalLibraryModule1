...
public class AdminChapterDetails {
    String chapterNum,topicNum,aboutChapter;
    int vdoCount,noteCount,qCount,chapterId;

    public AdminChapterDetails(String chapterNum, String topicNum, String aboutChapter, int vdoCount, int noteCount, int qCount, int chapterId) {
