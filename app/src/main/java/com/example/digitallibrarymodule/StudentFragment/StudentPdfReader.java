...
public class StudentPdfReader extends Fragment {
View view;
    String file,name;
    ImageView back;
    public StudentPdfReader(String file, String name) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.student_fragment_pdf_reader, container, false);
