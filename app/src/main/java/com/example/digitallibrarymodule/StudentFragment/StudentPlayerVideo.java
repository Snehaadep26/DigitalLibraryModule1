...
public class StudentPlayerVideo extends Fragment {
    ...
    public StudentPlayerVideo(String file, String title) {
        this.file=file;
        this.title=title;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=  inflater.inflate(R.layout.student_fragment_player_video, container, false);
